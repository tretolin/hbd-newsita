...
.bg {
    ...
    box-shadow: -42vw -4vh 0px 0px #fff, 25vw -41vh 0px 0px #fff,
        ...
        0vw 37vh 1px 1px #fff, 34vw -26vh 1px 0px #fff, -23vw -17vh 0px 0px #fff,
        ...
        28vw 33vh 1px 0px #fff, -49vw -4vh 0px 0px #fff, 16vw 32vh 0px 1px #fff,
        36vw -18vh 1px 0px #fff, -25vw -30vh 1px 0px #fff,
        -23vw 24vh 0px 1px #fff, -2vw -35vh 1px 1px #fff, -25vw 9vh 0px 0px #fff,
        -15vw -34vh 0px 0px #fff, -8vw -19vh 1px 0px #fff,
        -20vw -20vh 1px 1px #fff, 42vw 50vh 0px 1px #fff,
        -32vw 10vh 1px 0px #fff, 1vw 42vh 0px 0px #fff, 22vw 48vh 0px 1px #fff,
        39vw -8vh 1px 1px #fff, -6vw -42vh 1px 0px #fff, -47vw 34vh 0px 0px #fff,
        -46vw 19vh 0px 1px #fff, -12vw -32vh 0px 0px #fff,
        -45vw -38vh 0px 1px #fff, -28vw 18vh 1px 0px #fff,
        -38vw -46vh 1px 1px #fff, 49vw -6vh 1px 1px #fff,
        -28vw 18vh 1px 1px #fff, 10vw -24vh 0px 1px #fff,
    ...
    box-shadow: 24vw 9vh 1px 0px #fff, 12vw -24vh 6px 6px #119eee,
        -45vw -22vh 0px 0px #fff, -37vw -40vh 6px 1px #119eee,
        ...
        4vw 7vh 0px 0px #fff, 21vw 21vh 1px 1px #fff, 22vw -15vh 0px 0px #fff,
        45vw 49vh 0px 0px #fff, 43vw -27vh 1px 1px #fff, 20vw -2vh 0px 0px #fff,
        ...
        3vw -25vh 0px 1px #fff, 36vw 16vh 0px 1px #fff, 40vw 24vh 0px 0px #fff,
        18vw 11vh 0px 0px #fff, -39vw 14vh 0px 1px #fff, -40vw 31vh 0px 1px #fff,
